        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <div className="bg-[#2d1b4e]/50 border border-white/5 rounded-2xl p-5 h-[450px] relative shadow-xl backdrop-blur-sm">
                ...
                <div className="w-full h-[360px]">
                    ...
                    {chartData.length === 0 && <div className="absolute inset-0 flex items-center justify-center text-gray-500">Waiting for trades...</div>}
                </div>
            </div>
                        ...
                        <div className="space-y-1">
                            {tradeHistory.length === 0 ? <div className="text-center py-10 text-gray-500 text-sm">No trades yet.</div> : (
                                <div className="flex flex-col gap-1">
                                    <div className="grid grid-cols-4 text-[10px] font-bold text-gray-500 uppercase px-3 pb-2"><div>User</div><div>Type</div><div>Value</div><div className="text-right">Price</div></div>
